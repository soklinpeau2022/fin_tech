import 'package:fin_tech/service/data_month.dart';
...
class _WeekState extends State<Month> {
  ...
  void initState() {
    super.initState();
    _spendingDataFuture = DataServiceMonth.loadSalesData();
  }
                                              ...
                                              itemBuilder: (BuildContext context, int index) {
                                                ...
                                                return Padding(
                                                  ...
                                                  child: saleDetails != null ? Cards(
                                                    ...
                                                    spendto:'',
                                                    date: '${saleDetails.date?.year}-${saleDetails.date?.month}',
